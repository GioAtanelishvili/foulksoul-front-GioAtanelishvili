...
const MemberTextArea: React.FC<TextAreaProps> = (props) => {
  return (
    <div className='w-1/2 h-56 mt-11 mb-1 py-3 pl-2 pr-3 relative text-sm border border-primary-dark-blue rounded-[5px]'>
      <textarea
      ...
      />
      {props.error && (
        <p className='text-login-input-error w-full text-center absolute -bottom-6 font-medium'>
          {props.error.message}
        </p>
      )}
    </div>
